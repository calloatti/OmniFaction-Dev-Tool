...
namespace Calloatti.OmniFaction
{
  ...
  // ---- Static patcher (ensures Harmony patches are applied) ----
  public static class OmniFactionPatcher
  {
    static OmniFactionPatcher()
    {
      var harmony = new Harmony("calloatti.omnifaction");
      harmony.PatchAll();
    }
  }
