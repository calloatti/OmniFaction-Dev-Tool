...
namespace Calloatti.OmniFactionDevTool
{
  ...
  public static class Patch_RecoveredGoodStackFactory_Load
  {
    public static bool Prefix(RecoveredGoodStackFactory __instance, TemplateService ____templateService)
    {
      ...
      {
        __instance._recoveredGoodStackTemplate = recoveredGoodStackSpec.Blueprint;
        __instance.GoodStackBlockSpec = __instance._recoveredGoodStackTemplate.GetSpec<BlockObjectSpec>().Blocks.FirstOrDefault();
